...
//    NSString *filePath = @"/Users/CF/Desktop/LazyPDFKit/LazyPDFKitDemo/LazyPDFKitDemo/Document.pdf";
    ...
    if (document != nil) // Must have a valid LazyPDFDocument object in order to proceed with things
    {
        ...
        lazyPDFViewController.saveTitle = @"是否保存修改？";
        lazyPDFViewController.save = @"保存";
        lazyPDFViewController.cancel = @"取消";
